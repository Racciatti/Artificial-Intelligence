...
## Parâmetros que iremos utilizar
...
num_episodios = 1000 ## quantas vezes o agente irá jogar o jogo 
...
q_tabela = q_learning(alpha, gamma, epsilon, epsilon_decay, min_epsilon, num_episodios, max_passos, q_tabela_inicial)
